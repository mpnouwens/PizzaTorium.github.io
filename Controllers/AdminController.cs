...
namespace LibraryManagementSystem.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            //ViewBag.Campus = GetAllCampusAsSelectList();
        ...
        public ActionResult Create(ExpandedUserDTO paramExpandedUserDTO)
        {
            try
            {
                ...
                var Age = paramExpandedUserDTO.Age;
                var FirstName = paramExpandedUserDTO.Name;
                var UserID = paramExpandedUserDTO.UserID;
                ...
                if (AdminUserCreateResult.Succeeded == true)
                {
                    ...
                    if (strNewRole != "0")
                    {
                        ...
                        if (strNewRole == "Student")
                        {
                            ...
                            return RedirectToAction("Edit", "Students", new { id = student.StudentID_PK, student.UserID_FK });
                        }
                        if (strNewRole == "Staff")
                        {
                            var staff = new Staff()
                            ...
                            return RedirectToAction("Edit", "Students", new { id = staff.StaffID_PK, staff.UserID_FK });
                        }
        ...
        //#region private SelectListItem GetAallCampusAsSelectList()
        //private List<SelectListItem> GetAllCampusAsSelectList()
        //{
        //    List<SelectListItem> SelectCamousListItems =
        //        new List<SelectListItem>();

        //    var campusSelectList = db.Campus.OrderBy(x => x.Name).ToList();
        //    SelectCamousListItems.Add(
        //        new SelectListItem
        //        {
        //            Text = "Select",
        //            Value = "0"
        //        });
        //    foreach (var item in campusSelectList)
        //    {
        //        SelectCamousListItems.Add(
        //            new SelectListItem
        //            {
